...
memTest : bin/TestDriver
	valgrind --tool=memcheck --leak-check=yes --max-stackframe=5000000 --show-reachable=yes --suppressions=test/string.supp  bin/TestDriver
...
bin/TestDriver : obj/TestDriver.o lib/libutils.a obj/StopWords.o obj/Url.o
